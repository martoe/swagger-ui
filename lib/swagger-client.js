...
simpleRef = function(name) {
  ...
  if (typeof name === "object") {
    ...
    // "name" contains the full "$ref" content, which should be a string but in our case is { $ref="com.bawag.rest.hal.HALResource", properties={...}}
    return name["$ref"];
  }
...
SwaggerHttp.prototype.execute = function(obj) {
  if(obj && (typeof obj.url === 'string') && (obj.url.substring(0, 5) === 'file:'))
    this.useJQuery = true; // Shred doesn't support the "file" protocol
  else if(obj && (typeof obj.useJQuery === 'boolean'))
